  ...
  return (
    <div className="left-col">
      ...
      <div className="doc-list">
        {documents.length===0 && <div style={{padding:12,color:'#fff'}}>No documents yet. Upload to get started.</div>}
        {documents.map(doc=> (
          <div key={doc.id} className="doc-item">
            <div className="meta">
              ...
              <div>
                ...
                <div style={{fontSize:12,color:'#fff'}}>{doc.size ? `${Math.round(doc.size/1024)} KB` : ''}</div>
              </div>
            </div>
